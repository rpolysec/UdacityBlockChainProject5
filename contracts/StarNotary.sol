...
contract StarNotary is ERC721 {
    ...
    string public constant name = "StarLite Token";
    ...
    function createStar(string memory _name, uint256 _tokenId) public {
        ...
        Star memory newStar = Star(true, _name, this.name(), this.symbol());
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        // 1. Passing to star tokenId you will need to check if the owner of _tokenId1 or
        // _tokenId2 is the sender
